...
namespace bytetrade
{
  ...
  void to_variant( const uint128& var,  fc::variant& vo );
  void from_variant( const fc::variant& var,  uint128& vo );
...
// {
//     template<>
//     struct hash<bytetrade::uint128>
//     {
//        size_t operator()( const bytetrade::uint128& s )const
//        {
...
FC_REFLECT( bytetrade::uint128, (hi)(lo) )
